...
export const HomePage = () => {
      ...
      try {
        ...
        if (response.data.geonames) {
          ...
          const transformedCities = response.data.geonames.map((city) => ({
            ...city,
            toponymName:
              vietnameseNameMapping[city.toponymName] || city.toponymName,
          }));
  ...
  const goToDetail = (hotelId) => {
    navigate(
      `/hotel-detail/${hotelId}?checkin=${checkinDate}&checkout=${checkoutDate}&guests=${numberOfPeople}`
    );
  };
  ...
  return (
    <>
      ...
      <div className="position-relative">
        <div
          className="position-fixed bottom-1 right-1 bg-secondary text-light"
        ...
        >
          <h1 className="text-center fw-bold m-5 mt-5">
            Your next adventure is just a search away
          </h1>
        </motion.div>
        <div
          className="row mx-5 d-flex justify-content-center align-items-center p-0 py-2 rounded-2"
        ...
        >
          <div className="d-flex justify-content-between align-items-center">
            <h1 className="fw-bold m-5 mt-5">Địa Điểm Phổ Biến</h1>
            <h3
              className="text-decoration-underline mx-5"
              style={{ color: "#003b95" }}
            >
              Xem thêm
            </h3>
        ...
        <div className="row mx-5">
          {trendingRowFirst.map((item, index) => (
            <div
              key={index}
              className="col-md-6 mb-2 position-relative card-container"
            >
              {/* Ảnh */}
              <Image
                src={item.url}
                fluid
                className="w-100 card-des"
                style={{
                  borderRadius: "10px",
                  height: "50vh",
                  objectFit: "cover",
        ...
        <div className="row mx-5 mt-3">
          {trendingRowSecond.map((item, index) => (
            <div
              key={index}
              className="col-md-4 mb-2 position-relative card-container"
            >
              {/* Ảnh */}
              <Image
                src={item.url}
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }}
        >
          <h1 className="fw-bold m-5 mt-5">Chuẩn Bị Cho Chuyến Đi Tiếp Theo</h1>
        </motion.div>
        <motion.div
          ...
          <div className="row">
            ...
            <div className="col-md-6 d-flex align-items-center">
              <Card className="m-3 border-0 rounded w-100 position-relative overflow-hidden">
                ...
                >
                  <h2 className="fw-bold bottom-1">Khám phá Đà Nẵng</h2>
                  <p>Tìm điểm đến tốt hơn </p>
                  <Button
                    style={{
                      backgroundColor: "#003b95",
                      borderColor: "#003b95",
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }}
        >
          <h1 className="text-center fw-bold m-5 mt-5">Về Travelofy</h1>
        </motion.div>
        <motion.div
        ...
        >
          <div className="col-md-7 d-flex flex-column justify-content-center pe-md-4">
            <p className="fs-4 mb-3">
              Chào mừng đến với{" "}
              <span className="fw-bolder fs-2" style={{ color: "#003b95" }}>
                TRAVELOFY
              </span>
              , nền tảng đặt phòng lý tưởng cho việc lên kế hoạch du lịch dễ
              dàng. Dù bạn đang tìm kiếm một nơi ở ấm cúng, khu nghỉ dưỡng sang
              trọng, hay chỗ ở tiết kiệm, chúng tôi mang đến cho bạn những lựa
              chọn tốt nhất với giá cả không thể cạnh tranh hơn.
            </p>
            <p className="fs-4 mb-3">
              Tại Travelofy, chúng tôi tin rằng việc đặt chuyến phiêu lưu tiếp
              theo của bạn nên đơn giản, an toàn và minh bạch. Nền tảng của
              chúng tôi được thiết kế để cung cấp:
            </p>
            <div className="ms-2">
              <p className="fs-5 mb-2">✔️ Giá cả minh bạch, không phí ẩn</p>
              <p className="fs-5 mb-2">
                ✔️ Quy trình đặt phòng an toàn và bảo mật
              </p>
              <p className="fs-5 mb-2">
                ✔️ Đánh giá trung thực và hình ảnh thực tế
              </p>
            </div>
          </div>
        ...
        >
          <h3 className="text-center fw-bold p-3">Tham gia cùng Travelofy</h3>
          <h6 className="text-center text-muted">
            Đăng kí để nhận thông tin khuyến mãi mới nhất từ Travelofy
          </h6>
