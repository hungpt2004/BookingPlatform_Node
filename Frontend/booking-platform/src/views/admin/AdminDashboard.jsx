              ...
              <Card className="h-100 border-0 shadow-sm">
                <Card.Body className="p-4">
                  ...
                  <div className="d-flex align-items-center mt-3">
                    <Badge
                      bg={
                        dashboardData.pendingBookings > 10
                          ? "warning"
                          : "success"
                      }
                      className="me-2"
                ...
                <Card.Body className="p-4">
                  ...
                  <div className="timeline">
                    {[
                      {
                        time: "2 hours ago",
                        text: "New booking received for Grand Hotel",
                        type: "success",
                      },
                      {
                        time: "5 hours ago",
                        text: "Payment confirmed for reservation #38291",
                        type: "primary",
                      },
                      {
                        time: "Yesterday",
                        text: "Booking canceled for Mountain View Hotel",
                        type: "danger",
                      },
                      {
                        time: "2 days ago",
                        text: "New hotel added to the system",
                        type: "info",
                      },
                    ].map((activity, index) => (
                      <div key={index} className="d-flex mb-3">
                        <div
                          className={`bg-${activity.type} rounded-circle me-3`}
                          style={{
                            width: "10px",
                            height: "10px",
                            marginTop: "6px",
